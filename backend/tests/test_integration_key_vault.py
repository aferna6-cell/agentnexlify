...
# ---------------------------------------------------------------------------
# OAuth-token helpers (GH #266 step 2) — encrypt_oauth_tokens /
# decrypt_integration_row. Kept in this file because CI enforces 100%
# line+branch coverage of the vault module via THIS test file only.
# ---------------------------------------------------------------------------
