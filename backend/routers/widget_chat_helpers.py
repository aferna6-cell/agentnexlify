...
def _build_system_prompt(
    ...
    return (
        ...
        f"- When someone asks about pricing, services, availability, or wants a quote, naturally ask for their name and email or phone number so the team can follow up\n"
        f"- If the visitor has exchanged 3 or more messages and hasn't shared contact info yet, gently ask for their name and email or phone number so we can send them follow-up details — frame it as helpful, not pushy\n"
        f"- Don't ask for contact info on the very first message or casual greetings\n"
        f"- If they provide an email or phone number, thank them and move forward. Never ask for contact info again.\n"
