...
async def get_business_page(request: Request, slug: str):
    ...
    return BusinessPagePublic(
        ...
        widget_primary_color=widget.get("primary_color") or "#00BFFF",
        widget_bot_name=widget.get("bot_name") or "AI Assistant",
        widget_greeting=widget.get("greeting_message"),
        widget_position=widget.get("position") or "bottom-right",
        color_theme=(tenant.get("bp_color_theme") or "default") if "bp_color_theme" in allowed else "default",
