...
_BUSINESS_PROFILES: dict[str, dict] = {
    ...
    "home_services": {
        **deepcopy(_BASE_PROFILE),
        ...
        "subheadline": "Keep service calls moving, capture the right job details up front, and follow up until the work is scheduled.",
        "focus_areas": ["Leads", "Estimates", "Booked Jobs"],
        "conversation_label": "Customer Conversations",
        "lead_label": "Service Leads",
        "lead_empty_hint": "Estimate requests, repair calls, and photos from the widget will land here",
        "automation_label": "Follow-Ups Live",
        "automation_empty_hint": "Set up estimate reminders, callback nudges, and review requests",
        "appointment_label": "Jobs Booked This Week",
        "missed_call_label": "Missed Job Calls",
        "proof_metric_label": "Quote-ready jobs captured",
        "proof_metric_empty_hint": "Estimate requests, urgent repairs, and callbacks will count here",
        "widget": {
            "bot_name_suffix": "Scheduling Desk",
            "primary_color": "#0f766e",
            "greeting_template": "Hi! Thanks for reaching out to {business_name}. Are you looking for a repair, an estimate, or help with an existing job?",
            "position": "bottom-right",
        },
        "quick_actions": [
            {"label": "Book Estimate", "description": "Schedule a site visit or quote", "action": "book"},
            {"label": "Add Service Lead", "description": "Create a new repair or estimate inquiry", "action": "lead"},
