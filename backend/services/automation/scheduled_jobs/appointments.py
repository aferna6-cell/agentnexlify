"""Scheduled jobs — appointment-related automations."""
import html
...
from backend.services.automation.templates import _REBOOK_INTERVALS, _AFTERCARE_TEMPLATES
from backend.services.automation.trigger import BATCH_LIMIT
from backend.services.automation.scheduled_jobs._common import logger, _get_reminder_extras
