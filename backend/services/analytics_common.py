"""Shared analytics constants + helpers (cache, periods, scoring, recommendations).

Canonical home moved from backend/routers/analytics/_common.py (audit
2026-07-14 M2): the control_center services imported from the routers package,
inverting the layer boundary. Routers and services now both import downward
from here; routers/analytics/_common.py remains as a thin re-export shim so
the seven analytics router modules keep their existing imports."""
