...
const SUBJECT_PATTERNS: [SubjectType, RegExp][] = [
  ...
  // Documents before invoices so "refund policy" / "one-pager" stay admin
  // records work rather than billing. Invoice nouns still win on "overdue
  // invoice" because they do not match the document pattern.
  [
    "document",
