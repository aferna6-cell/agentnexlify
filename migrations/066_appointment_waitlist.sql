-- Migration 066: Appointment Waitlist
-- When all slots are booked, visitors can join a waitlist.
-- When a cancellation opens a slot, auto-notify waitlisted leads.
...
CREATE TABLE IF NOT EXISTS waitlist_entries (
    ...
    preferred_time_end TEXT,    -- e.g. "17:00"
...
CREATE INDEX idx_waitlist_tenant_date ON waitlist_entries(tenant_id, preferred_date) WHERE status = 'waiting';
