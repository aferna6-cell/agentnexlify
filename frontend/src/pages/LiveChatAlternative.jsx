...
const data = {
  ...
  comparison: {
    ...
    rows: [
      {
        feature: "AI-first (no human needed)",
        nexlify: "Yes \u2014 fully autonomous AI",
        nexlifyClass: "check",
        competitor: "No \u2014 human agent required",
        competitorClass: "cross",
      },
      {
        feature: "Works after hours",
        nexlify: "Yes \u2014 24/7 automatic",
        nexlifyClass: "check",
        competitor: "Only with staff online",
        competitorClass: "cross",
      },
      {
        feature: "SMS channel",
      ...
      {
        feature: "Local business features",
        nexlify: "Yes \u2014 vertical AI training",
        nexlifyClass: "check",
        competitor: "No \u2014 generic tool",
        competitorClass: "cross",
      },
      {
      ...
      {
        feature: "Staff scheduling needed",
        nexlify: "No \u2014 AI is always on",
        nexlifyClass: "check",
        competitor: "Yes \u2014 agents must be online",
        competitorClass: "cross",
      },
    ],
  },
