...
const data = {
  meta: {
    ...
    description:
      "Intercom costs $74+/month per seat. AgentNexLiFy is flat-rate from $19.99/mo with AI chat, SMS automation, and missed call text-back \u2014 built for local businesses, not enterprises.",
    canonical: "https://agentnexlify.com/intercom-alternative",
  },
  hero: {
    h1: "Intercom Costs $74+/Month Per Seat.",
    h1Accent: "NexLiFy is $19.99/mo.",
    subtitle:
    ...
    primaryCta: "Get More for Less \u2014 Get Started \u2192",
  ...
  comparison: {
    ...
    rows: [
      { feature: "Starting price", nexlify: "From $19.99/mo", nexlifyClass: "check", competitor: "~$74/seat/mo", competitorClass: "cross" },
    ...
    cards: [
      {
        ...
        body: "Intercom\u2019s $74/seat/mo adds up fast. A 3-person team costs $222/mo before add-ons. NexLiFy\u2019s AI Workforce plan is $99.99/mo flat \u2014 no matter how many people access the dashboard. Includes SEO, marketing campaigns, and AI content tools.",
      },
      {
        icon: "zap",
  ...
  cta: {
    ...
    note: "No commitment. No setup fees. No enterprise sales pitch.",
  },
};
