      ...
      <div className="settings-page-grid">
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            Add your website URL and we'll scan it to automatically train your
            AI assistant about your business.
          </p>
          <div className="settings-field">
          ...
          >
            <button
              ...
              disabled={
                crawling ||
                (!form.website_url && !(businessSlug && businessPageEnabled))
              }
            >
              {crawling
                ? "Scanning..."
          ...
          {crawlStatus && crawlStatus.crawl_status !== "none" && (
            ...
            >
              {crawlStatus.crawl_status === "completed" && (
                <span>
                  AI knowledge base updated with content from{" "}
                  {crawlStatus.pages_found} page
                  {crawlStatus.pages_found !== 1 ? "s" : ""}. Your AI assistant
              ...
              {crawlStatus.crawled_at && (
                ...
                >
                  Last scanned:{" "}
                  {new Date(crawlStatus.crawled_at).toLocaleDateString(
                    "en-US",
          ...
          {!form.website_url &&
            (!crawlStatus ||
              ...
              >
                <strong>No website?</strong> You can still train your AI
                assistant:
                <ul
                  style={{
                    margin: "6px 0 0",
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            Get texted when new leads come in.
          </p>
          <div className="settings-field">
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            Paste your Google review URL here. Used by the Review Request
            automation template.
          </p>
          <div className="settings-field">
            ...
            <>
              <div className="settings-field">
                ...
                <textarea
                  ...
                  onChange={(e) => {
                    setForm((f) => ({
                      ...f,
                      textback_message: e.target.value,
                    }));
                    setSaved(false);
                  }}
                  rows={3}
              ...
              <div className="settings-field">
                ...
                >
                  ...
                  Missed calls during quiet hours will be texted when quiet
                  hours end.
                </p>
                <div
                  style={{
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        setForm((f) => ({
                          ...f,
                          textback_quiet_start: e.target.value,
                        }));
                        setSaved(false);
                      }}
                      style={{
                  ...
                  >
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        setForm((f) => ({
                          ...f,
                          textback_quiet_end: e.target.value,
                        }));
                        setSaved(false);
                      }}
                      style={{
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            Provision a dedicated business phone number to enable the AI
            Answering Service, Missed Call Text-Back, and Two-Way SMS with your
            leads.
          </p>
          ...
          {provisionedPhone ? (
            ...
            <div>
              ...
              >
                ...
                >
                  Calls and SMS are routed through this number to your AI
                  assistant.
                </div>
              </div>
              <button
            ...
            <div>
              ...
              {availableNumbers.length > 0 && (
                <div style={{ marginTop: 8 }}>
                  ...
                  >
                    {availableNumbers.length} number
                    {availableNumbers.length !== 1 ? "s" : ""} available
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    This will purchase the first available number and configure
                    it for your account.
                  </span>
                </div>
              )}
              ...
              {!availableNumbers.length && !searchingNumbers && (
                ...
                >
                  A provisioned number enables: AI Answering Service, Missed
                  Call Text-Back, and Two-Way SMS. Search above to get started.
                </div>
              )}
            </div>
          )}
        ...
        {businessSlug && (
          <div className="settings-card">
            ...
            <p className="settings-card-desc">
              ...
              directly. Embed the widget on any website to let visitors book
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            Define tags for AI auto-categorization of conversations. System tags
            are built-in; add custom tags for your business needs.
          </p>
          ...
          {tagDefs.length === 0 ? (
            ...
            >
              No tags defined yet. Add custom tags below, or the AI will use
              default categories when auto-tagging conversations.
            </p>
          ) : (
            <div
              style={{
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            ...
            Fields appear in the lead detail panel and can be filled in for any
            contact.
          </p>

          {cfLoadError && (
            <p
              style={{ color: "#f87171", fontSize: "0.85rem", marginBottom: 8 }}
            >
              {cfLoadError}
            </p>
          )}
          ...
          {customFieldDefs.length === 0 && !cfLoadError ? (
            ...
            >
              No custom fields yet. Add fields below to track additional
              information on your leads, such as "Preferred contact time",
        ...
        {knowledgeStats && (
          <div className="settings-card">
            ...
            <p className="settings-card-desc">
              What your AI chatbot currently knows. The more sources, the better
              your AI can help visitors.
            </p>
            <div
              style={{
                display: "grid",
            ...
            >
              ...
              {knowledgeStats.menu_items_count > 0 && (
                ...
                >
                  ...
                  >
                    {knowledgeStats.menu_items_count}
                  </div>
                  <div style={{ fontSize: 13, color: "var(--text-secondary)" }}>
                    Menu Items
                  </div>
              ...
              {knowledgeStats.job_postings_count > 0 && (
                ...
                >
                  <div
                    style={{ fontSize: 24, fontWeight: 700, color: "#22c55e" }}
                  >
                    {knowledgeStats.job_postings_count}
                  </div>
                  <div style={{ fontSize: 13, color: "var(--text-secondary)" }}>
                    Active Job Postings
                  </div>
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            ...
            thumbs-down feedback are automatically used to improve future
            responses.
          </p>
          {feedback.length === 0 ? (
            <p style={{ color: "var(--text-muted)", fontSize: "0.85rem" }}>
              No feedback yet. Visitors can rate AI responses with thumbs
              up/down in the chat widget.
            </p>
          ) : (
            <div
              style={{
                ...
                >
                  <div>
                    <span style={{ marginRight: 8 }}>
                      {fb.rating === "thumbs_up" ? "\u{1F44D}" : "\u{1F44E}"}
                    </span>
                    {fb.correction ? (
        ...
        <div className="settings-card">
          ...
          <p className="settings-card-desc">
            ...
            appointments, invoices, documents, and service history. Clients
            register through their portal link and can then access their account
            anytime.
          </p>
          <div
            className="settings-field"
