            ...
            {(detailDoc.status === "sent" || detailDoc.status === "viewed") && (
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                  ...
                  />
                  <button
                    onClick={() => handleCopyLink(detailDoc)}
                    style={{
                      background:
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <div>
                ...
                >
                  Selecting a lead will auto-fill signer details if they are
                  empty
                </div>
              </div>
          ...
          >
            ...
            {sendMethod !== "sms" && !sendTarget.signer_email && (
              <div style={{ ...warnBox("245,158,11"), color: "#f59e0b" }}>
                No signer email set. Email delivery will fail. Edit the document
                to add an email address first.
              </div>
            )}
            {sendMethod !== "email" && !sendTarget.signer_phone && (
              <div style={{ ...warnBox("245,158,11"), color: "#f59e0b" }}>
                No signer phone set. SMS delivery will fail. Edit the document
                to add a phone number first.
              </div>
            )}
            ...
            >
              <button onClick={() => setShowSendModal(false)} style={cancelBtn}>
                Cancel
              </button>
              <button
                className="btn-primary"
