...
const allNavItems = [
  ...
  { key: "marketing_dashboard", icon: <Icon d="M18 20V10M12 20V4M6 20v-6" />, label: "Marketing Dashboard" },
  ...
  { key: "ab_tests", icon: <Icon d="M3 3h8v8H3zM13 13h8v8h-8zM13 3h8v8h-8zM3 13h8v8H3z" />, label: "A/B Tests" },
  { key: "automation_rules", icon: <Icon d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />, label: "Automation Rules" },
  { key: "trigger_logs", icon: <Icon d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M8 11h8M8 15h6" />, label: "Trigger Logs" },
  { key: "email_sequences", icon: <Icon d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zM22 6l-10 7L2 6M8 14h8M8 18h5" />, label: "Email Sequences" },
  ...
  { key: "admin_analytics", icon: <Icon d="M18 20V10M12 20V4M6 20v-6" />, label: "Platform Analytics" },
  { key: "admin_promotions", icon: <Icon d="M12 2l3 7h7l-5.5 4.1 2.1 6.9-6.6-4.8-6.6 4.8 2.1-6.9L2 9h7z" />, label: "Free & Discounts" },
];
...
const NAV_GROUPS = [
  ...
  { key: "marketing",      label: "MARKETING",         items: ["content_studio", "marketing_dashboard", "local_seo", "social_media", "campaigns", "ab_tests", "automation_rules", "trigger_logs", "email_sequences", "form_builder"] },
  ...
  { key: "admin",          label: "ADMIN",             items: ["admin_analytics", "admin_promotions"] },
];
