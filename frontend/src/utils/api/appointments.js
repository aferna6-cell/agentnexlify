...
export function rescheduleAppointment(tenantId, token, appointmentId, startTime, endTime) {
  return request(`/api/v1/appointments/${tenantId}/${appointmentId}/reschedule`, {
    method: "POST", token,
