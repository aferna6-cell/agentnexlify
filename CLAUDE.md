...
This project is indexed by GitNexus as **agentnexlify** (7873 symbols, 18201 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
