...
This matches the M9.4 live command: missing key hard-fails before
provider invocation. Confirmed 2026-09-03:

```text
python3 scripts/run_m9_planner_bakeoff.py --mode live --sample stratified --limit 24 --repetitions 0
RuntimeError: live bakeoff requires ANTHROPIC_API_KEY (or use mode=fixture / inject planner=)
```
