...
Three splits, three different permissions:
  ...
  validation  agent-service/evals/datasets/validation/validation-v3.json
                                                    select models and inspect
...
VALIDATION_VERSIONS = {"v3": "action-eval-validation-v3"}
#: Milestone 6 selects models only against independently authored validation-v3.
DEFAULT_VALIDATION = "v3"
...
def load_validation(version: str = DEFAULT_VALIDATION) -> Split:
    """The frozen Milestone 6 model-selection split."""
