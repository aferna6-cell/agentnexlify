...
VALIDATION_VERSIONS = {
    "v1": "action-eval-validation-v1",
    "v2": "action-eval-validation-v2",
    "v3": "action-eval-validation-v3",
}
#: Milestone 6 selects models against v3 (independent, leakage-checked).
#: v2 was used in earlier experiments; v1 is a regression check only.
