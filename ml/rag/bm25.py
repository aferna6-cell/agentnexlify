"""In-process BM25 for Milestone 7 retrieval bakeoff and eval.

No Elasticsearch / pg_bm25 dependency. Deterministic. Used when Voyage is
absent and as the lexical baseline even when dense is available.
"""
