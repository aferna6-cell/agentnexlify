...
- **Value digest is LIVE** (`send_weekly_digest` in the 30-min loop, `main.py`). Follow-through (in progress): confirm targeting/empty-state, leave a seam for opportunity highlights.
