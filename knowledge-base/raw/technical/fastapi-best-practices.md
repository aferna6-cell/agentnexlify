---
title: "GitHub - zhanymkanov/fastapi-best-practices: FastAPI Best Practices and Conventions we used at our startup · GitHub"
source_url: "https://github.com/zhanymkanov/fastapi-best-practices"
fetched_at: "2026-04-19T22:06:44Z"
category: "technical"
---

# GitHub - zhanymkanov/fastapi-best-practices: FastAPI Best Practices and Conventions we used at our startup · GitHub
...
Working with an AI agent? See [AGENTS.md](/zhanymkanov/fastapi-best-practices/blob/master/AGENTS.md) for the same rules in a
...
[简体中文](/zhanymkanov/fastapi-best-practices/blob/master/README_ZH.md)
...
- Server's event loop and all queued tasks wait until `time.sleep()` finishes

Since the route is `async`, the server doesn't offload it to a threadpool—it blocks the entire event loop
...
- FastAPI sends the entire `good_ping` route to the threadpool, where a worker thread runs the function
...
- [https://stackoverflow.com/questions/62976648/architecture-flask-vs-fastapi/70309597#70309597](https://stackoverflow.com/questions/62976648/architecture-flask-vs-fastapi/70309597#70309597)

Here you can also check [my answer](https://stackoverflow.com/a/70309597/6927498)

- [https://stackoverflow.com/questions/65342833/fastapi-uploadfile-is-slow-compared-to-flask](https://stackoverflow.com/questions/65342833/fastapi-uploadfile-is-slow-compared-to-flask)

- [https://stackoverflow.com/questions/71516140/fastapi-runs-api-calls-in-serial-instead-of-parallel-fashion](https://stackoverflow.com/questions/71516140/fastapi-runs-api-calls-in-serial-instead-of-parallel-fashion)
...
[](/zhanymkanov/fastapi-best-practices/blob/master/images/value_error_response.png)
...
[](/zhanymkanov/fastapi-best-practices/blob/master/images/custom_responses.png)
...
- Migrations must be static and reversible. If your migrations depend on dynamically generated data, make sure only the data itself is dynamic, not its structure.

- Generate migrations with descriptive names and slugs. The slug is required and should explain the changes.

- Set a human-readable file template for new migrations. We use the `*date*_*slug*.py` pattern, e.g., `2022-08-24_post_content_idx.py`
