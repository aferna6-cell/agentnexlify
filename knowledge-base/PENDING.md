...
## Compiled 2026-04-12 (previous + this run)
...
- [ai-llm] Home Anthropic → `wiki/ai-llm/anthropic-mission-and-latest-releases.md`
- [ai-llm] Careers Anthropic → `wiki/ai-llm/anthropic-careers-and-culture.md`
- [technical] pgvector GitHub → `wiki/technical/pgvector-postgres-vector-search.md`
- [technical] pgvector GeeksforGeeks → `wiki/technical/pgvector-implementation-guide.md`
- [regulations] HIPAA (CDC) → `wiki/regulations/hipaa-overview-cdc.md`
- [regulations] HIPAA (Wikipedia) → `wiki/regulations/hipaa-titles-and-security-rule-2024-nprm.md`
- [ai-llm] Claude Opus 4.6 → `wiki/ai-llm/claude-opus-4-6-capabilities.md`
- [ai-llm] Claude Sonnet 4.6 → `wiki/ai-llm/claude-sonnet-4-6-capabilities.md`

## Ingested 2026-04-12T22:54:23Z — cron autopop

- ~~[ai-llm] Claude Opus 4.6~~ → compiled `wiki/ai-llm/claude-opus-4-6-capabilities.md`
- ~~[ai-llm] Introducing Sonnet 4.6~~ → compiled `wiki/ai-llm/claude-sonnet-4-6-capabilities.md`
- ~~[competitors] The 15-minute AI responder~~ → compiled `wiki/competitors/ghl-15-minute-ai-responder.md`
- ~~[competitors] HighLevel March 2026 Email Marketing Report~~ → compiled `wiki/competitors/ghl-email-marketing-march-2026.md`

## Ingested 2026-04-13T06:00:00Z — cron autopop
...
- ~~[ai-llm] anthropic-harness-design-long-running-apps~~ → compiled `wiki/ai-llm/harness-design-long-running-apps-gan.md` (2026-04-21 cron)
...
- ~~[ai-llm] `raw/ai-llm/a-postmortem-of-three-recent-issues-anthropic.md`~~ → compiled `wiki/ai-llm/anthropic-postmortem-three-issues-2025.md` (2026-04-21 cron)
- ~~[ai-llm] `raw/ai-llm/designing-ai-resistant-technical-evaluations-anthropic.md`~~ → compiled `wiki/ai-llm/ai-resistant-technical-evaluations.md` (2026-04-21 cron)
...
- ~~[frontier_ai] Digital Applied — Frontier Model Q3 2026 Release Forecast → `raw/frontier-ai/frontier-model-q3-2026-release-forecast.md`~~ COMPILED 2026-08-26 → `wiki/ai-llm/frontier-model-q3-2026-release-forecast.md`
- ~~[frontier_ai] AI Release Tracker — August 2026 frontier releases → `raw/frontier-ai/ai-release-tracker-august-2026.md`~~ COMPILED 2026-08-26 → `wiki/ai-llm/ai-release-tracker-august-2026.md`
- ~~[small_biz_saas] Artisan Growth — SaaS Churn Benchmarks 2026 (500+ companies) → `raw/small-biz-saas/saas-churn-benchmarks-2026-500-companies.md`~~ COMPILED 2026-08-26 → `wiki/small-biz-saas/saas-churn-benchmarks-2026-500-companies.md`
- ~~[small_biz_saas] SaaS Mag — Vertical AI Agents Are Eating Horizontal SaaS → `raw/small-biz-saas/vertical-ai-agents-eating-horizontal-saas-2026.md`~~ COMPILED 2026-08-26 → `wiki/small-biz-saas/vertical-ai-agents-eating-horizontal-saas-2026.md`
