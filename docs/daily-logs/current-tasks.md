...
- [ ] AI Contact Suggestions: lead update suggestions (Tier 0, 2/4)
- [ ] AI Contact Suggestions: dashboard review panel (Tier 0, 3/4)
- [ ] Flow Analytics — track node triggers, drop-off points (Flow Builder follow-up)
...
- [ ] Help article: "Managing your leads"
- [ ] Help article: "Setting up appointment booking"
- [ ] Onboarding email sequence (Day 1, 3, 7, 14)

## Completed (Recent)

- [x] Help article: "How to configure your AI assistant" — Cycle 42 (2026-03-15)
- [x] Help article: "Understanding your analytics dashboard" — Cycle 42 (2026-03-15)
- [x] Error handling hardening (Anthropic + SMS) — Cycle 41 (2026-03-15)
- [x] Visual Chat Flow Builder page — Cycle 40 (2026-03-15)
- [x] Widget cleanup + N+1 fix + silent catches + validation — Cycle 39 (2026-03-15)
