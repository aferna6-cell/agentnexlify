# Onboarding Day 7 — One Week Check-In
...
It's been a week since you set up your AI assistant for {{business_name}}. Here's a quick check to make sure you're getting the most out of it.

**Is your widget on every page?**

The AI can only talk to visitors on pages where the widget is installed. If it's only on your homepage, you're missing conversations from people who land on service pages, your about page, or blog posts.

Check: is the embed code on every page of your site?
